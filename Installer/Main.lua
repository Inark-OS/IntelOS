...
local repositoryURL = "https://raw.githubusercontent.com/Inark-OS/IntelOS/master/"
local installerURL = "Installer/"
local EFIURL = "EFI/Minified.lua"

local installerPath = "/IntelOS installer/"
...
local function title()
	...
	centrizedText(y, 0x2D2D2D, "IntelOS")
...
local installerMenu = menu:addContextMenuItem("IntelOS", 0x2D2D2D)
...
addStage(function()
	...
	if not selectedFilesystemProxy.getLabel() then
		selectedFilesystemProxy.setLabel("IntelOS HDD")
	end
	...
	EEPROMProxy.setLabel("IntelOS EFI")
